package("kb.util", function (exports) {
	...
	function scrollTowards(target) {
		if (typeof target === "undefined" || target === null || target.parentNode === null) {
			return true;
		}
		...
		var parent = target.parentNode,
			...
			overBottom =
				target.offsetTop - parent.offsetTop + target.clientHeight >
				parent.scrollTop + parent.clientHeight,
			overLeft = target.offsetLeft - parent.offsetLeft < parent.scrollLeft,
			overRight =
				target.offsetLeft - parent.offsetLeft + target.clientWidth >
